  ...
  <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
    ...
    <div>
      <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
        ...
        <Button color="dark" class="flex items-center justify-center !gap-3">
          <template #start>
            <svg
              width="21"
              class="fill-current"
      ...
      <VBaseForm ref="formRef" @submit.prevent="handleSubmit">
        <div class="space-y-5">
          ...
          <VBaseInput
            ...
            :rules="[rules.required]"
          />
          <BaseCheckbox v-model="formData.keepLoggedIn">
          ...
          <Button type="submit" class="w-full" color="primary"> Sign Up </Button>
        </div>
      </VBaseForm>
      <div class="mt-5">
