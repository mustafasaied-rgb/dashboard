    ...
    <div>
      ...
      <div class="relative z-20 bg-transparent">
        <select
          ...
          class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pe-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
        ...
        <span
          class="absolute z-30 text-gray-700 -translate-y-1/2 pointer-events-none end-4 top-1/2 dark:text-gray-400"
        >
          <svg
